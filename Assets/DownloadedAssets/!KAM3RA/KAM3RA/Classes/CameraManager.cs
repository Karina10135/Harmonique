...
namespace KAM3RA
{
    public class CameraManager : MonoBehaviour
    {
        ...
        public delegate void OnPlayerAttached(PlayerController actor, PlayerController last);
        ...
        public virtual PlayerController Player
        {
            get { return player; }
            set
            {
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (hitCamera.distance != Mathf.Infinity)
            {
                ...
                speedDistance += Mathf.Max(Mathf.Abs(viewDelta.x), Mathf.Abs(viewDelta.y));
            }
